    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings Vert(uint vertex:SV_VertexID,uint instance:SV_InstanceID)
            {
                ...
                if(_DrawBoundaries!=0){Boundary b=_Boundaries[instance];Body body=_Bodies[b.body];float bs,bc;sincos(body.angle,bs,bc);g.center=body.center+float2(bc*b.center.x-bs*b.center.y,bs*b.center.x+bc*b.center.y);g.angle=body.angle;g.identity=0;p*=2*b.halfSize;}else g=_Grains[instance];
